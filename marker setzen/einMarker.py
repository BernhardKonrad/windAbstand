...
def writeMarker(file,lat,lng,whichMap='map-canvas'):
	file.write('var marker = new google.maps.Marker({position:new google.maps.LatLng(' + str(lat) + ', ' + str(lng) + '),icon:"http://maps.google.com/mapfiles/ms/icons/blue-dot.png"});')
